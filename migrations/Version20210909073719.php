 ...
 */
final class Version20210909073719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cartes_cadeaux ADD dr_id INT DEFAULT NULL, DROP site_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cartes_cadeaux ADD site_id INT NOT NULL, DROP dr_id');
